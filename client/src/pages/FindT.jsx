        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-900 p-4">
                <div className="bg-zinc-700 p-8 rounded-lg shadow-md w-full max-w-sm">
                    <h2 className="text-2xl font-bold text-center mb-6 text-white">Find Books by Title</h2>
                    <form className="space-y-4">
                        <div>
                            <label htmlFor="titleSearch" className="block text-sm font-semibold mb-2 text-white">Title:</label>
                            <input type="text" id="titleSearch" name="titleSearch" required
