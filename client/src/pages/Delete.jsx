...
import deleteBook from "../utils/deleteBook.js"
        ...
        <>
            ...
            <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-900 p-4">
                <div className="bg-zinc-700 p-8 rounded-lg shadow-md w-full max-w-sm">
                    <h2 className="text-2xl font-bold text-center mb-6 text-white">Delete Book</h2>
                    <form onSubmit={deleteBook} className="space-y-4">
                        <div>
                            <label htmlFor="deleteTitle" className="block text-sm font-semibold mb-2 text-white">Title:</label>
